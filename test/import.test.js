...
const HBSP_URL =
  "<canvas url>/courses/38458/external_tools/retrieve?url=https%3A%2F%2Fservices.hbsp.harvard.edu%2Flti%2Flinks%2FH03PQF-PDF-ENG%2Frich-text";
...
test("readWorklist reads report-skipped.csv with dest_dir and dedupes by URL", () => {
  ...
  fs.writeFileSync(
    ...
    `url,reason,dest_dir,course_name,course_url\r\n` +
      `${HBSP_URL},HBSP content not accessible,${dest},15.716,<canvas url>/courses/38458\r\n` +
      `${HBSP_URL},HBSP content not accessible,,15.716,<canvas url>/courses/38458\r\n`
  );
